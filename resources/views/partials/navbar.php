...
if (App\Models\User::isLoggedIn()): ?>
    <?php if (App\Models\User::getLoggedIn()->is_admin): ?>
			<a class="navlink" href="<?php echo BASE_URL . "/admin"; ?>"><i class="ri-admin-line"></i></a>
	<?php else: ?>
            <a class="navlink" href="<?php echo BASE_URL . "/admin"; ?>"><i class="ri-user-settings-line"></i></a>
    <?php endif;?>
...
<?php endif;?>
    ...
    <?php require_once __DIR__ . "/admin/lowernav.php";?>
</nav>
